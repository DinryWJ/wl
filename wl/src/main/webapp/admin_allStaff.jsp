...
<div class="panel-body">
        ...
        <div class="table-primary">
          <table class="table table-striped table-bordered" id="datatables" >
            ...
            <tbody>
            <c:forEach var="as" items="${astaff}">
              <tr id="cloneTr">
                <td><c:out value="${as.staffId}"></c:out></td>
                <td><c:out value="${as.email}"></c:out></td>
                <td><c:out value="${as.name}"></c:out></td>
                <td><c:out value="${as.gender}"></c:out></td>
                <td><c:out value="${as.position}"></c:out></td>
                <td><a class="btn btn-primary btn-3d"  href="/admin_searchStaff.html?search=<c:out value="${as.email}"></c:out>">修改</a></td>
