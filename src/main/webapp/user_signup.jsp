      ...
      <div class="modal-content">
        ...
        <form action="/user_signupCheck.html" class="p-a-4">
          ...
          <fieldset class="page-signup-form-group form-group form-group-lg">
            ...
            <input type="text" class="page-signup-form-control form-control" placeholder="昵称" name="name">
          </fieldset>

          <fieldset class="page-signup-form-group form-group form-group-lg">
            <div class="page-signup-icon text-muted"><i class="ion-asterisk"></i></div>
            <input type="password" class="page-signup-form-control form-control" placeholder="密码" name="password">
        ...
        <div class="p-y-3 p-x-4 b-t-1 bg-white darken">
          <div class="text-xs-center m-t-2 font-weight-bold font-size-14" id="px-demo-signup-link text-black">已拥有账号? <a href="/index.html"><u>现在登录</u></a>
          </div>
        </div>
