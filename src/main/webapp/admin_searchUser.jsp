...
<title>搜索用户 工作人员端 物流信息管理平台</title>
...
<body>
	...
	<div class="px-content">
		...
		<div class="page-header panel m-b-0 p-y-0 b-a-0 border-radius-0">
			<form action="/admin_searchUser.html" 
		...
		<div class="tab-content p-y-0">
			...
			<c:if test="${!empty user}">
				<form action="/admin_updateUser.html" class="panel form-horizontal"
					method="post">
							...
							<div class="col-md-12 row">
								...
								<div class="col-md-6">
									<label class="control-label">地址</label> <input type="text"
										value="${user.address}" name="address" placeholder=""
										class="form-control form-group-margin">
								</div>
								<div class="col-md-6 ">
								...
								<div class="col-md-6">
									<label class="control-label">注册日期</label> <input type="text"
										value="${user.createtime}" name="createtime" placeholder=""
										class="form-control form-group-margin">
								</div>
								<div class="col-md-6">
									<label class="control-label">更新日期</label> <input type="text"
										value="${user.updatetime}" name="updatetime" placeholder=""
										class="form-control form-group-margin">
								</div>
							...
							<div class="col-md-12 row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label">是否封号</label> <select
